...
│   ├── setup_github_secrets.ps1 # Masked secret setup
...
#    Nhắn /start cho bot, rồi tìm chat ID (token được nhập ẩn):
python scripts/telegram_setup.py

# 2) Cấu hình token + chat ID bằng prompt masked vào GitHub Secrets:
